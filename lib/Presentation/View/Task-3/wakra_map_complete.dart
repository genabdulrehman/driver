...
class WakraComplete extends StatefulWidget {
  bool fromStation;
  bool isPick;
  String sliderTitle;
  ...
  @override
  State<WakraComplete> createState() => _WakraCompleteState();
}

class _WakraCompleteState extends State<WakraComplete> {
  @override
                  ...
                  children: [
                    ...
                    SwipeSlider(
                      onSubmit: () {
                        ...
                        if (!widget.fromStation) {
                          pickUpController.getPickups.length == 1
                              ? Get.to(MoveToMetro(
                                  isPickup: widget.isCall ? true : false,
                                ))
                              : Get.to(Pickup());

                          pickUpController.onComplete();
                        } else {
