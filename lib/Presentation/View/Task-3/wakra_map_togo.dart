...
import 'package:drive_app/Presentation/View/Task-3/wakra_map_arrive.dart';
...
class WakraMapToGo extends StatefulWidget {
  bool isPickup;
  bool fromStation;
  WakraMapToGo({
    Key? key,
  ...
  @override
  State<WakraMapToGo> createState() => _WakraMapToGoState();
}

class _WakraMapToGoState extends State<WakraMapToGo> {
  @override
