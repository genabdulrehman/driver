...
class ReadyToDrop extends StatefulWidget {
  const ReadyToDrop({Key? key}) : super(key: key);

  @override
  State<ReadyToDrop> createState() => _ReadyToDropState();
}

class _ReadyToDropState extends State<ReadyToDrop> {
